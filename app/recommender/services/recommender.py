from app.music_recommender.model.popularity import popularity_recommender
import numpy as np
import pandas as pd
...
rawData = pd.merge(
    rawData1_userIndexed,
    rawData2.drop_duplicates(["song_id"]),
    on="song_id",
    how="left",
)
